const lenguaje = (es) => { return 'es' } //Español  

const smsAvisoRG = () => { return `╰⊱✅⊱ *RESULTADO BENJAEXE-BOT* ⊱✅⊱╮\n\n` } 
const smsAvisoAG = () => { return `╰⊱⚠️⊱ *ADVERTENCIA BENJAEXE-BOT* ⊱⚠️⊱╮\n\n` }
const smsAvisoIIG = () => { return `╰⊱❕⊱ *INFORMACIÓN BENJAEXE-BOT* ⊱❕⊱╮\n\n` }
const smsAvisoFG = () => { return `╰⊱❌⊱ *ERROR BENJAEXE-BOT* ⊱❌⊱╮\n\n` }
const smsAvisoMG = () => { return `╰⊱❗️⊱ *ACCIÓN MAL USADA BENJAEXE-BOT* ⊱❗️⊱╮\n\n` }
const smsAvisoEEG = () => { return `╰⊱📩⊱ *REPORTE BENJAEXE-BOT* ⊱📩⊱╮\n\n` }
const smsAvisoEG = () => { return `╰⊱💚⊱ *ÉXITO BENJAEXE-BOT* ⊱💚⊱╮\n\n` }

const smsRowner = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO BENJAEXE-BOT LO PUEDE USAR!!\`\`\`` }
const smsOwner = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO MI CREADOR BENJAEXE-BOT LO PUEDE USAR!!\`\`\`` }
const smsMods = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO MODERADORES Y MI CREADOR BENJAEXE-BOT LO PUEDEN USAR!!\`\`\`\`` }
const smsPremium = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO ESTA DISPONIBLE PARA USUARIOS PREMIUM Y MI CREADOR BENJAEXE-BOT!! PARA SER PREMIUM COMPRE UN PASE USANDO #pass premium\`\`\`` }
const smsGroup = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO SE PUEDE UTILIZAR EN GRUPOS!!\`\`\`` }
const smsPrivate = () => { return `\`\`\`¡¡ESTE COMANDO SÓLO SE PUEDE UTILIZAR AL PRIVADO DE !BENJAEXE-BOT!\`\`\`` }
...
const smsUnreg = () => { return `\`\`\`¡¡NECESITAS ESTAR REGISTRADO(A) PARA USAR ESTE COMANDO, ESCRIBE #benjaverificar PARA REGISTRARTE!!\`\`\`` }
const smsRestrict = () => { return `\`\`\`¡¡ESTE COMANDO ESTÁ RESTRINGIDO POR MI CREADORA BENJAEXE-BOT!!\`\`\`` }

//main.js
const smsWelcome = () => { return `*╭┈⊰* @subject *⊰┈ ✦*\n*┊ BIENVENIDO(A) BENJAEXE-BOT!!*\n┊ @user\n┊ *LEA LA DESCRIPCIÓN DEL GRUPO Y DISFRUTE EL BOT DE BENJAEXE-BOT*\n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈ ✦*\n${String.fromCharCode(8206).repeat(850)}\n@desc`}
const smsBye = () => { return '*╭┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*\n┊ *@user*\n┊ *DESPEDIDA DE PARTE DE BENJAEXE-BOT!!* \n*╰┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈⊰*'}
...
//_antiprivado 
const smsprivado = () => { return `*NO PUEDE USAR A BENJAEXE-BOT EN CHAT PRIVADO*\n\n*Unirte al Grupo oficial del bot para poder usar el bot*`}
...
const smsCreB = () => { return 'Me llamo BENJAEXE-BOT'}
const smsCreC = () => { return 'Siempre a disposición para ayudarte BENJAEXE-BOT'}
...
//info-gruposofc.js
const smsGrupoOfc1 = () => { return '*◜🌺 GRUPOS OFICIALES DE BENJAEXE-BOT◞*'}
...
//info-infobot.js
const smsBT1 = () => { return 'CREADOR BENJAEXE-BOT'}
...
//grupos-admins.js
const smsSetW = () => { return `${lenguajeGB['smsAvisoEG']()}*LA BIENVENIDA DEL GRUPO HA SIDO CONFIGURADA BENJAEXE-BOT*`}
...
//grupos-admins.js
const smsDest = () => { return `${lenguajeGB['smsAvisoEG']()}*LA DESCRIPCIÓN DEL GRUPO HA SIDO CONFIGURADA BENJAEXE-BOT*`}
...
//grupo-tagall.js
const smstagaa = () => { return `BENJAEXE-BOT LOS INVOCA A TODOS`}
...
//_allantilink.js 
const smsTextoYT = () => { return 'BENJAEXE-BOT - 𝗪𝗵𝗮𝘁𝘀𝗔𝗽𝗽 '} 
const smsApagar = () => { return '❌ DESACTIVAR BENJAEXE-BOT'} 
const smsEncender = () => { return '✅ ACTIVAR BENJAEXE-BOT'} 
...
//config-on y off.js
const smsParaAdmins = () => { return `PARA ADMINS Y CREADOR BENJAEXE-BOT : GRUPOS`}
const smsParaAdYOw = () => { return `PARA ADMINS Y CREADOR BENJAEXE-BOT : CHATS`}
const smsParaOw = () => { return `PARA CREADOR BENJAEXE-BOT : CHATS`}
...
smsAutodetec3, smsAutodetec4, smsAutodetec5, smsAutodetec6, smsAutodetec7, smsImageGg, smsGit, languageSave, languageRegister, smsMainBot }
